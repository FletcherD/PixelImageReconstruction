...
MediumUNet is a more sophisticated model for simple patch reconstruction.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train MediumUNet for patch prediction')
